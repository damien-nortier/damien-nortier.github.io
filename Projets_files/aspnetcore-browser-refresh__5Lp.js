setTimeout(async function () {
  ...
  const webSocketUrls = 'wss://localhost:44340/BlazorApp/,ws://localhost:53011/BlazorApp/'.split(',');
  const sharedSecret = await getSecret('');
  let connection;
